...
- `FIXM CCB` organisation will be controlled and performed by the `FIXM CCB` members with the support of a `FIXM CCB Secretariat`  (see Article 3 – The CCB Secretariat (“CCBS”)), which remains under the direction of the `FIXM CCB`.
